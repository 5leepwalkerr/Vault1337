package com.company.codehelp.test_support;

import com.company.codehelp.CodeHelpApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.codehelp.screen")
@ContextConfiguration(classes = {CodeHelpApplication.class, UiTestAssistConfiguration.class})
